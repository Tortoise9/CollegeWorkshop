...
const ProductDetail = () => {
  ...
  console.log(id)
    ...
    useEffect(()=>
    {
        ...
        fetch(`https://dummyjson.com/products/${id}`).then(response=>response.json()).then(responseJson=>{
        ...
        <div className="flex flex-col md:flex-row -mx-4">
            <div className="md:flex-1 px-4">
                <div className="h-[460px] rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
                    <img className="w-full h-full object-cover" src={product.thumbnail} alt="Product Image"/>
                </div>
